...
metadata: {"opencane":{"emoji":"🧵","os":["darwin","linux"],"requires":{"bins":["tmux"]}}}
---
...
- Scan all sockets: `{baseDir}/scripts/find-sessions.sh --all` (uses `OPENCANE_TMUX_SOCKET_DIR`, falls back to legacy env).
