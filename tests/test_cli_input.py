...
from opencane.cli import commands
...
def mock_prompt_session():
    ...
    with patch("opencane.cli.commands._PROMPT_SESSION", mock_session), \
         patch("opencane.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("opencane.cli.commands.PromptSession") as mock_session_cls, \
         patch("opencane.cli.commands.FileHistory"), \
