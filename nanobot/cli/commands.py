...
def config_check(
    ...
    from nanobot.config.loader import _migrate_config, convert_keys, get_config_path
...
def hardware_serve(
    ...
    from nanobot.api.hardware_server import HardwareControlServer, create_adapter_from_config
    from nanobot.api.lifelog_service import LifelogService
    from nanobot.api.vision_server import VisionService
    from nanobot.bus.queue import MessageBus
    from nanobot.config.loader import load_config
    ...
    from nanobot.safety.policy import SafetyPolicy
    from nanobot.session.manager import SessionManager
    from nanobot.storage import SQLiteObservabilityStore
